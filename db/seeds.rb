# rails db:seed will run this file
cats = [
  {
    name: 'Felix',
    age: 2,
...
# iterating over the cats array
# each method takes a block
# passing each cat hash into the AR create method
# printing an outcome for visual feedback
cats.each do |each_cat|
  Cat.create(each_cat)
  puts "Created cat: #{each_cat}"
end